      ...
      queue: [
        {
          ...
          filePath: '/path/to/recording_1.m4a',
  ...
  it('should successfully request presigned URL and upload file content to S3', async () => {
    mockFetch.mockResolvedValueOnce({
      ...
      json: jest.fn().mockResolvedValue({
        success: true,
        data: {
          upload_url: 'https://s3.amazonaws.com/pocket-bucket/recording_1.m4a',
          id: 'pocket-id-999'
        }
      })
    });
    ...
    expect(mockFetch).toHaveBeenNthCalledWith(1, 'https://public.heypocketai.com/api/v1/public/recordings/upload-url', {
      ...
      body: JSON.stringify({
        ...
        duration: 30,
        file_name: 'recording_1.m4a',
        recording_at: '2026-06-03T12:00:00Z',
        title: 'Recording 1'
      })
    });

    expect(mockFetch).toHaveBeenNthCalledWith(2, 'https://s3.amazonaws.com/pocket-bucket/recording_1.m4a', {
      method: 'PUT',
      headers: {
